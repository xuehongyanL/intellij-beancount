...
public class BeancountLinkValueImpl extends ASTWrapperPsiElement implements BeancountLinkValue {

  public BeancountLinkValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitLinkValue(this);
  }
