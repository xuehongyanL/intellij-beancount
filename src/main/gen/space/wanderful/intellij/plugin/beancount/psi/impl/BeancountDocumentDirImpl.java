...
public class BeancountDocumentDirImpl extends ASTWrapperPsiElement implements BeancountDocumentDir {

  public BeancountDocumentDirImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitDocumentDir(this);
  }
