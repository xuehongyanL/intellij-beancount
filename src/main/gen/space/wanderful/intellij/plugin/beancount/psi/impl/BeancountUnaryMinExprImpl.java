...
public class BeancountUnaryMinExprImpl extends BeancountExprImpl implements BeancountUnaryMinExpr {

  public BeancountUnaryMinExprImpl(@NotNull ASTNode node) {
    super(node);
  }
