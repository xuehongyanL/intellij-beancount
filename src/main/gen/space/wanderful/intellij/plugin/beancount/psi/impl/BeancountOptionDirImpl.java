...
public class BeancountOptionDirImpl extends ASTWrapperPsiElement implements BeancountOptionDir {

  public BeancountOptionDirImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitOptionDir(this);
  }
