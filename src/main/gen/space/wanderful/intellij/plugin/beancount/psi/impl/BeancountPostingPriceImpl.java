...
public class BeancountPostingPriceImpl extends ASTWrapperPsiElement implements BeancountPostingPrice {

  public BeancountPostingPriceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitPostingPrice(this);
  }
