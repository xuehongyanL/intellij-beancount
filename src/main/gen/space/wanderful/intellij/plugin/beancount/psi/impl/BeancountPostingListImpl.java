...
public class BeancountPostingListImpl extends ASTWrapperPsiElement implements BeancountPostingList {

  public BeancountPostingListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitPostingList(this);
  }
  ...
  @Override
  @NotNull
  public List<BeancountPostingLine> getPostingLineList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BeancountPostingLine.class);
  }
