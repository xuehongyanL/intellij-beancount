...
public class BeancountAmountImpl extends ASTWrapperPsiElement implements BeancountAmount {

  public BeancountAmountImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitAmount(this);
  }
