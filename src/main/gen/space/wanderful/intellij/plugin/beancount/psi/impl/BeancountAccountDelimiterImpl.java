...
public class BeancountAccountDelimiterImpl extends ASTWrapperPsiElement implements BeancountAccountDelimiter {

  public BeancountAccountDelimiterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitAccountDelimiter(this);
  }
