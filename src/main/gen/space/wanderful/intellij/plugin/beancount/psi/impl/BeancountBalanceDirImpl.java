...
public class BeancountBalanceDirImpl extends ASTWrapperPsiElement implements BeancountBalanceDir {

  public BeancountBalanceDirImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitBalanceDir(this);
  }
