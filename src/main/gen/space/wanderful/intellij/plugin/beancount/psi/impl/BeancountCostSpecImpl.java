...
public class BeancountCostSpecImpl extends ASTWrapperPsiElement implements BeancountCostSpec {

  public BeancountCostSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitCostSpec(this);
  }
