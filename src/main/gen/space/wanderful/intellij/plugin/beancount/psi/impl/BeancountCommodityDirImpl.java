...
public class BeancountCommodityDirImpl extends ASTWrapperPsiElement implements BeancountCommodityDir {

  public BeancountCommodityDirImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitCommodityDir(this);
  }
