...
public class BeancountIncludeDirImpl extends ASTWrapperPsiElement implements BeancountIncludeDir {

  public BeancountIncludeDirImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitIncludeDir(this);
  }
