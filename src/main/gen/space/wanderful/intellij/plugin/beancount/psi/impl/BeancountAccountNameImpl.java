...
public class BeancountAccountNameImpl extends ASTWrapperPsiElement implements BeancountAccountName {

  public BeancountAccountNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitAccountName(this);
  }
