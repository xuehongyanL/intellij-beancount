...
public class BeancountQueryDirImpl extends ASTWrapperPsiElement implements BeancountQueryDir {

  public BeancountQueryDirImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitQueryDir(this);
  }
